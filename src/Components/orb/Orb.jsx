...
const frag = /* glsl */ `
  ...
  vec4 mainImage(vec2 fragCoord) {
    ...
    float floatSize = min(iResolution.x, iResolution.y);
    vec2 uv = (fragCoord - center) / floatSize * 2.0;
...
export default function Orb({
  ...
  // Track props without triggering re-renders
  ...
  }, []); // Empty dependency array, safe because frag/vert are outside
